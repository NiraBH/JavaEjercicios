...
public class ListaPersonas {
	...
	/**
	 * 
	 * Metdo que inserta un objeto Persona en la lista de personas
	 * 
	 * @param persona
	 *            La persona que se quiere introducir
	...
	/**
	 * Metodo que permite buscar a una persona por su nombre en la lista
	 * 
	 * @param nombre
	 *            El nombre de la persona a buscar
	...
	public void listarPersonas() {
		...
		for (int i = 0; i < this.num_personas; i++) {
			...
			// System.out.println(persona_actual.getEdad()); //metodo
			// alternativo
			// System.out.println(persona_actual.getNombre());// el otro es el
			// preferido por favorecer la encapsulacion y la reutilizaci�n
		}
	}
