	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			rset = stmt.executeQuery(
					"UPDATE employees salary set salary = (salary *1.2) where DEPARTMENT_ID IN (select department_id FROM DEPARTMENTS WHERE DEPARTMENT_NAME = 'ADMINISTRATION' or department_name = 'IT')");
			while (rset.next()) {
