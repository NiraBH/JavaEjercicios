...
public class BuscarLetra {
		...
		public static boolean PalabraConI (String palabra) //declaramos una variable booleana para determinar si la palabra tiene i o no
		{
			...
			char car_aux = 0;
				...
				while ((!siTieneI) && (indice<longi)) //en caso de que no tengaI y el indice sea menor que la longitud de la palabra
					{
		...
		public static void main(String[] args) {
			...
			for(int i=0; i<args.length; i++) //recorrer la palabra
			{
				...
				if (PalabraConI(args[i])) //llamamos al metodo laPalabraTieneI e indicarmos si args contiene i se imprima dicha palabra
				{
